...
BOARD_PREBUILT_DTBOIMAGE := device/xiaomi/courbet-kernel/dtbo.img

TARGET_PREBUILT_KERNEL := device/xiaomi/courbet-kernel/Image
TARGET_PREBUILT_DTB := device/xiaomi/courbet-kernel/dtb.img
PRODUCT_COPY_FILES += \
    device/xiaomi/courbet-kernel/dtb.img:$(TARGET_COPY_OUT)/dtb.img
